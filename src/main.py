...
def main():
    ...
    print("### Test rev schunk")
    myschunk = schunk.Schunk()
    myschunk = myschunk.push_back(1)
    myschunk = myschunk.push_back(2)
    print("myschunk = ", end="")
    myschunk.print_general(print_item)
    print("Reversing...")
    revchunk = myschunk.rev()
    print("revchunk = ", end="")
    revchunk.print_general(print_item)
    print("myschunk = ", end="")
    myschunk.print_general(print_item)

    print("--- Pushing back 4 into revchunk")
    print("revchunk = ", end="")
    revchunk.print_general(print_item)
    print("Push back...")
    revchunk = revchunk.push_back(3)
    print("revchunk = ", end="")
    revchunk.print_general(print_item)
    print("Push front 0")
    revchunk = revchunk.push_front(0)
    print("revchunk = ", end="")
    revchunk.print_general(print_item)
    print("Pop front & pop back")
    revchunk, x = revchunk.pop_front()
    revchunk, x = revchunk.pop_back()
    print("revchunk = ", end="")
    revchunk.print_general(print_item)
    print("concating myschunk")
    cncchunk = revchunk.concat(myschunk)
    print("myschunk = ", end="")
    myschunk.print_general(print_item)
    print("concatchunk = ", end="")
    cncchunk.print_general(print_item)
    print("revchunk = ", end="")
    revchunk.print_general(print_item)
    print("")
    ...
    myschunk = myschunk.push_back(1)
    myschunk = myschunk.push_back(2)
    myschunk = myschunk.push_back(3)
    myschunk = myschunk.push_back(4)
    print("myschunk = ", end="")
    myschunk.print_general(print_item)
    print("Reversing...")
    myschunk = myschunk.rev()
    print("myschunk = ", end="")
    myschunk.print_general(print_item)
